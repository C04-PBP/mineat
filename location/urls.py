...
from location.views import show_location, location_details, location_search_ajax, show_json, show_json_by_id
...
urlpatterns = [
    ...
    path('json/<str:id>', show_json_by_id, name="json_restaurant")
]